---
title: "DNSSEC"
source: "https://textbook.cs161.org/network/dnssec.html"
author:
published:
created: 2026-04-13
description: "Online textbook for CS 161: Computer Security at UC Berkeley."
tags:
  - "clippings"
---
## 33\. DNSSEC
...
![Diagram of a recursive DNS query, where your resolver queries the root nameserver first in query 1 and response 2, then the nameserver at the second level of the tree in query 3 and response 4, then a nameserver at the third level of the tree in query 5 and response 6](https://textbook.cs161.org/assets/images/network/dns/dnsquery.png)
...
![Diagram depicting a ZSK used to sign records](https://textbook.cs161.org/assets/images/network/dnssec/zsk.png)
...
![Diagram depicting a KSK used to sign a ZSK, which is then used to sign records](https://textbook.cs161.org/assets/images/network/dnssec/ksk.png)
